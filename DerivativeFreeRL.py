...
np.fill_diagonal(cov, theta_std)

# Use Cross-Entropy to explore the parameter vector space to maximize reward
for iteration in xrange(n_iter):
    # Sample parameter vectors
    thetas = np.random.multivariate_normal(theta_mean, cov, batch_size)
    ...
    cov = np.cov(elite_thetas, rowvar=0)
